...
type PrePrintPreparedCardProps = {
...
export default function PrePrintPreparedCard({
  preparedRows,
  ...
  onDeletePrepared,
  onPrint,
}: PrePrintPreparedCardProps) {
  return (
    <Card className="border-slate-200 shadow-sm">
      <CardHeader>
        <CardDescription>รายการที่บันทึกไว้ — ลบรายการที่ไม่ต้องการก่อนส่งพิมพ์</CardDescription>
      </CardHeader>
